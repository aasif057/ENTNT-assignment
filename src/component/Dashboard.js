...
import React from 'react';
import { Link } from 'react-router-dom';
import products from '../product.json'; // Assuming you have a product JSON file
import orders from '../order.json'; // Assuming you have an order JSON file
import { LineChart, Line, CartesianGrid, XAxis, YAxis, Tooltip } from 'recharts';
...
const Dashboard = ({ sidenavbar }) => {
    ...
    orders.forEach(order => {
        totalRevenue += parseInt(order.total_amount);
    });

    return (
        <div className={`container container-responsive ${sidenavbar ? 'sidenavbar-active' : 'sidenavbar-inactive'}`} style={{ backgroundColor: "#ffffff" }}> {/* Light skin tone color */}
            <div className='row text-center'>
            <h1><span style={{ borderBottom: '2px black' }}>Dashboard</span></h1>
            </div>
            <hr />
            {/* <div className="d-flex justify-content-center align-items-center"> Centering both vertically and horizontally */}
            <div className='row'>
                <div className='col-md-4'>
                    <div className="card mb-3 card2" style={{ backgroundColor: "#dc6b3e" }}>
                        <div className="row g-0">
                            <div className="col-md-8 col-8">
                                <div className="card-body">
                                    <h2 className="card-title">{totalProducts}</h2>
                                    <h5 className="card-text">Total Products</h5>
                                    <Link to='/product' className='btn btn-primary'><strong>View More</strong></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className='col-md-4'>
                    <div className="card mb-3 card2" style={{ backgroundColor: "#ccb62e" }}>
                        <div className="row g-0">
                            <div className="col-md-8 col-8">
                                <div className="card-body">
                                    <h2 className="card-title">{totalOrders}</h2>
                                    <h5 className="card-text">Total Orders</h5>
                                    <Link to='/orders' className='btn btn-primary'><strong>View More</strong></Link>
                                </div>
                            </div>
                ...
                <div className='col-md-4'>
                    <div className="card mb-3 card2" style={{ backgroundColor: "#4c8377" }}>
                        <div className="row g-0">
                            <div className="col-md-8 col-8">
                                <div className="card-body">
                                    <h2 className="card-title">&#36; {totalRevenue}</h2>
                                    <h5 className="card-text">Total Revenue</h5>
                                </div>
                            </div>
                            {/* <div className="col-md-4 col-4">
