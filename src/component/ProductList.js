                                                ...
                                                <div className="card mb-3 " style={{ maxWidth: "540px", boxShadow: "4px 4px 6px 1px grey" }}>
                                                    ...
                                                    <div className='row g-0 mb-2'>
                                                        <div className='col-md-5 col-5' style={{ display: "flex", justifyContent: "center" }}>
                                                            <button className='btn' data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={() => onEdit(item)} style={{ backgroundColor: "#5fcc37", borderRadius: "15px 0px", color: "white" }}><strong>Update</strong></button>
                                                        </div>
                                                        <div className='col-md-5 col-5' style={{ display: "flex", justifyContent: "center" }}>
